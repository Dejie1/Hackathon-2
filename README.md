...
While playing the game, the players are able to make their own decision in some scenarios. The choice they made will affect their future. Here is an example of the scenario:
...
- Deal with actions
The players are able to deal with actions while exploring the mysterious area in the game. This is the menu that directs the players to deal with actions:
```c++
